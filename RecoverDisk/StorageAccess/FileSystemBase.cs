...
namespace RecoverDisk.StorageAccess
{
    ...
    public class FileSystemBase : EventReporter, IFileSystemBase
    {
        #region Data
        ...
        public static BootSectorCommon ParseBootSector(MbrPartitionTable pt, byte[] buffer)
        {
            ...
            LoadFsConstants(bscmn);
            return bscmn;
        }

        public static void LoadFsConstants(BootSectorCommon bscmn)
        { 
            ...
            if (bscmn.FsType == FsType.FAT12)
            {
                ...
                bscmn.MaxFatEntrySzConst = ClusterNum.MaxFAT12;
            }
            else if (bscmn.FsType == FsType.FAT16)
            {
                ...
                bscmn.MaxFatEntrySzConst = ClusterNum.MaxFAT16;
            }
            else if (bscmn.FsType == FsType.FAT32)
            {
                ...
                bscmn.MaxFatEntrySzConst = ClusterNum.MaxFAT32;
            }
            else if (bscmn.FsType == FsType.ExFAT)
            {
                ...
                bscmn.MaxFatEntrySzConst = ClusterNum.MaxExFAT;
            }
            else if (bscmn.FsType == FsType.NTFS)
            {
                bscmn.BytesPerFatConst = FatConst.ClusterByteCountFAT32;
        ...
        public virtual long GetAbsoluteLocation(long clusterNum)
        {
