...
namespace RecoverDisk.StorageAccess
{
    ...
    public class BootSectorCommon
    {
        ...
        public uint MaxFatEntrySzConst { get; set; }
    ...
    public class FatEntry
    {
        ...
        public DateTime FullCreationTime
        {
            get
            {
                int ct = CreateTime;
                int cd = CreateDate;
                return new DateTime(1980 + (cd >> 9), (cd >> 5) & 0xF, cd & 0x1F,
                    (ct >> 11) & 0x1F, (ct >> 5) & 0x3F, (ct & 0x1F) * 2);
            }
        }
        ...
        public FileAttributes Attributes
        {
            get
            {
                ...
                if ((Attribute & (int)EntryAttributes.Directory) != 0)
                    attrs |= FileAttributes.Directory;
                if ((Attribute & (int)EntryAttributes.Archive) != 0)
                    attrs |= FileAttributes.Archive;
                if ((Attribute & (int)EntryAttributes.Hidden) != 0)
                    attrs |= FileAttributes.Hidden;
                if ((Attribute & (int)EntryAttributes.SystemFile) != 0)
                    attrs |= FileAttributes.System;
                if ((Attribute & (int)EntryAttributes.ReadOnly) != 0)
